...
# Journal historique — État du développement (2026)

> Archive du journal append-only de `04-Etat-actuel-du-dev.md`.
> Détail chronologique des « Mises à jour complémentaires » du 2026-05-22 au 2026-06-26.
> NE PAS LIRE par défaut. Source vivante de l état présent : `../04-Etat-actuel-du-dev.md`.
> Détail par session : `../Sessions/`.
