...
|---|---|---|---|---|---|---|
| PO2-THERM-001 | Outil de métré thermique (`thermique.patrimoineaucarre.com`) — projet à part, hébergé sur l'infra Po2 | En cours | Projet distinct (pas en concurrence avec Po2) | — | Géométrie des plans puis métrés et ponts thermiques, pour les thermiciens privés en bureau d'études | Étape 1 en prod (PR #178, migration `0076`), site en ligne, connexion unique. Étape 2 : géométrie (murs, cloisons, menuiseries) en moteur autonome + import DXF. Décisions et questions : `thermique/metre-thermique-decisions.md`. |
