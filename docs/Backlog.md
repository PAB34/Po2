...
| PO2-FACT-001 | Audit facture ENGIE complet + socle historique EDF | En cours | P1 | BPU, TURPE, ENEDIS, lot historique ENGIE | Decision facture fiable + historique depenses/tarifs | XLSX ENGIE prioritaire : import asynchrone, upsert avec preservation decisions, controle BPU/TURPE/ENEDIS, rapport fournisseur filtre, suivi mensuel conso facturee vs ENEDIS + couverture factures/PRM. 9 filtres facettes livres (commit `9b2c8ca`) : mois, PRM/PCE, FIC, site, commune, segment, code tarif, libelle tarif, type document — avec correction graphe mensuel per-site. Dernier controle local : `MesFactures_20260522150740.xlsx` vs `BPU_2026_Lots_1_2_et_7.xlsx` = 5368 lignes tarifaires, 5355 OK, 13 ecarts potentiels, 0 reference BPU manquante. Prochaine marche : relancer deploy OVH quand Docker Hub repond puis reimport XLSX avec force update. |
| PO2-CPE-001 | Controle factures DALKIA CPE Ville | En cours | P0 | Matrice codification DALKIA, export finances DALKIA, DPGF Lot 1, indices P2/P3 | Fiche liaison finance fiable, validation/refus facture, suivi P1/P2/P3 | Socle finance livre : imports, matrice editable, historique factures, export XLSX detaille, controles nature/site/type/total/periode/P2/P3/P2.4. Perimetre corrige : contrats hors CPE Ville non bloques par absence de site. Premier controle P1 gaz Lot 1 livre pour `C00190116O` : acompte = 1/4 de `341 293,06 EUR HT` DPGF revise 2026, tolerance 1%/100 EUR. Prochaine marche : reimporter matrice + export, valider sur factures `C00190116O`, puis passer les references DPGF en base editable et ajouter reconciliation lignes multi-sites. |
| PO2-CPE-002 | Refonte Formules et indices CPE | Todo | P0 | Migration 0030, controles P2/P3, workflow PDF livre | Referentiel contradictoire fiable et centralise | Renommer `Indices` en `Formules et indices`. Ne pas modifier 0030 deja deployee : ajouter une migration pour rendre la preuve PDF reutilisable sans facture obligatoire, historiser les statuts, rattacher plusieurs factures et brancher les alertes de nouveaux coefficients XLSX vers l'import PDF centralise. Voir `energie/CPE-DALKIA/15-Formules-indices-et-travaux-P3.md`. |
...
| PO2-UX-001 | Reorganiser la navigation metier | Todo | P2 | Rapprochements patrimoine stabilises, tests utilisateur sur modules livres | Interface plus lisible | Recomposer la navigation autour de Patrimoine, Energie, Technique/CPE et Contrats apres validation des flux deja livres. Eviter de refaire les ecrans avant la console de rapprochement. |
