...
|---|---|---|---|---|---|---|
| PO2-THERM-001 | Outil de métré thermique (`thermique.patrimoineaucarre.com`) | En cours | P1 (priorisé par l'utilisateur le 2026-09-11) | DNS `thermique` (action utilisateur) | Métrés et linéaires de ponts thermiques assistés, pour la Ville et des bureaux d'études | Étape 1 (comptes, import PDF, visionneuse en tuiles, échelle) en prod (PR #178, migration `0076`). Étape 2 : détection des murs + import DXF. Décisions et questions : `thermique/metre-thermique-decisions.md`. |
