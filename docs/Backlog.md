...
| PO2-CVC-001 | Import inventaire materiels CVC terrain | Todo | P1 | `saas/CVC/listing materiels V2.xlsx`, referentiel SYPEMI | Fiche technique batiment, maintenance, BACS futur | Mapper les colonnes site/batiment/local/famille/marque/modele/date MES vers `BuildingEquipment` ou un modele etendu. |
