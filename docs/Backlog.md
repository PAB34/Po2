...
| PO2-PAT-002 | Import patrimoine hierarchique site/batiment/local | En cours | P1 | Fichier inventaire avec colonne Typologie | Import fidele du listing patrimoine et rattachement des locaux | Demarre 2026-05-20. Preview import detecte l'onglet utile, la colonne `Typologie`, les parents et les locaux. Frontend cree sites/batiments puis rattache les lignes LOCAL au parent. Reste a valider en CI/prod et cadrer un vrai modele `Site` si besoin relation parent-enfant durable. |
