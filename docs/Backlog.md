...
|---|---|---|---|---|---|---|
| PO2-THERM-001 | Outil de métré thermique (`thermique.patrimoineaucarre.com`) — projet à part, hébergé sur l'infra Po2 | En cours | Projet distinct (pas en concurrence avec Po2) | — | Géométrie des plans puis métrés et ponts thermiques, pour les thermiciens privés en bureau d'études | E2/E3 en production ; F1, F3 et le lot nord/édition terminés localement sur `feat/thermique-socle-raster`. Le plan affiche cotes, surfaces, ponts et éléments ; le thermicien pose le nord, corrige au lasso et dispose d'un menu contextuel. Prochaine action : accord explicite de déploiement des commits locaux, puis F0 (file d'attente/relais local) et F2/F4. Décisions : `thermique/parcours-par-niveau-E3bis-decisions.md`, `thermique/metres-sur-plan-F3-decisions.md`, `thermique/nord-et-edition-plan-decisions.md`. |
