...
| PO2-FACT-001 | Audit facture ENGIE complet | En cours | P1 | BPU, TURPE, ENEDIS, lot historique ENGIE | Decision facture fiable + historique depenses/tarifs | Priorite immediate : industrialiser `/energie/factures` pour les 83 PDF ENGIE avec import lot persistant, donnees normalisees et qualification du parser reel ; conserver la matrice `saas/specs/05_matrice_controles_factures_energie.md`. |
