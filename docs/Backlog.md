...
| PO2-FACT-001 | Audit facture ENGIE complet | En cours | P1 | BPU, TURPE, ENEDIS, lot historique ENGIE | Decision facture fiable + historique depenses/tarifs | Import lot persistant, filtres de revue et rapport fournisseur filtrable livres sur `/energie/factures`. Prochaine action : qualifier les 83 PDF en production, exploiter le titulaire Ville/Agglomeration dans les analyses et traiter les anomalies de controle revelees par le lot reel. |
