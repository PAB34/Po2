...
## Avancement backend matrices — complet et mergé - 2026-06-25

Le backend des matrices est désormais **complet et mergé dans `main`** (CI verte) en trois PR :

- **#26** : schéma versionné + service à invariants + router + seed + ADR 010 ;
- **#27** : import/export XLSX (round-trip `stable_rule_key`, diff preview, commit en version brouillon), avec tests ;
