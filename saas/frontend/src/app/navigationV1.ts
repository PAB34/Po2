...
export const navigationV1: NavSectionV1[] = [
  { label: "Pilotage", items: [{ key: "cockpit", label: "Mon cockpit", to: "/" }, { key: "invoices", label: "Factures & décisions", to: "/factures", badge: "12" }, { key: "sites", label: "Sites 360°", to: "/patrimoine/sites" }] },
