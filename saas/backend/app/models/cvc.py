...
class CvcInventoryItem(Base):
    ...
    provider: Mapped[str] = mapped_column(String(40), nullable=False, server_default="DALKIA", index=True)
    ...
    type_equipement: Mapped[str | None] = mapped_column(String(255), nullable=True)
    ...
    puissance: Mapped[str | None] = mapped_column(String(100), nullable=True)
    puissance_frigorifique: Mapped[float | None] = mapped_column(Float, nullable=True)
    puissance_calorifique: Mapped[float | None] = mapped_column(Float, nullable=True)
    capacite: Mapped[float | None] = mapped_column(Float, nullable=True)
    ...
    duree_vie_restante_source: Mapped[str | None] = mapped_column(String(40), nullable=True)
